...
import {
  ...
  Mail, Lock, Globe, CheckCircle2, Loader2, Fingerprint
} from 'lucide-react';
...
export default function RegisterSpace() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Appel du moteur de provisionnement EaaS
      ...
      alert("Erreur de propulsion : " + (err.response?.data?.message || "L'identifiant est peut-être déjà pris."));
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white flex items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      {/* GLOW BACKGROUNDS - pointer-events-none pour ne pas gêner le clic */}
      ...
      <div className="max-w-[450px] w-full relative z-10">
        ...
        <div className="flex items-center justify-between mb-10 px-2">
          {[1, 2].map((s) => (
            <div key={s} className="flex items-center gap-3">
              <div
                className={`w-9 h-9 rounded-xl flex items-center justify-center font-black text-xs transition-all duration-500
                ${step >= s
        ...
        <form
          ...
          className="relative bg-white/5 backdrop-blur-2xl border border-white/10 p-8 rounded-4xl shadow-2xl overflow-hidden"
        >

          {/* NOISE OVERLAY - pointer-events-none est CRUCIAL ici */}
            ...
            <div className="relative z-20 animate-in fade-in slide-in-from-right-4 duration-500">
              ...
              <div className="space-y-4">
                ...
                <div className="relative">
                  ...
                  >
                    <option value="general">Secteur : Général</option>
                    <option value="tech">Secteur : Technologie</option>
                    <option value="ecol">Secteur : Éducation</option>
                  </select>
                </div>
              </div>
            ...
            <div className="relative z-20 animate-in fade-in slide-in-from-right-4 duration-500">
              ...
              <div className="flex gap-3 mt-8">
                ...
                <button 
                  ...
                  className="btn-primary flex-2 flex justify-center items-center"
                >
